...
export const languages: Languages = {
  goBackHome: translation("Retourner à l'accueil", "Back to home", "Volver a la página de inicio"),
  h1: translation(
  ...
  messageForm: translation("Votre message...", "Your message...", "Su mensaje..."),
  ...
  studiedStacks: translation("Stacks étudiées", "Studied stacks", "Stacks estudiadas"),
